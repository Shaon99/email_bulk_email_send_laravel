                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="email_method" id="" class="form-control selectric">
                                                    ...
                                                    <option value="php"
                                                        <?php echo e(@$general->email_method == 'php' ? 'selected' : ''); ?>>
                                                ...
                                                <?php if(@$general->email_method == 'smtp'): ?>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="text" name="email_config[smtp_host]"
                                                                class="form-control"
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="text" name="email_config[smtp_port]"
                                                                class="form-control"
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dhakaClub\core\resources\views/backend/email/config.blade.php ENDPATH**/ ?>