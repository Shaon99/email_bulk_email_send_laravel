        ...
        <div class="section-body ">
            ...
            <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card p-3">
                        <div class="card-body">
                            <form action="<?php echo e(route('admin.sendgroupEmail')); ?>" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="invalid-feedback">
                                        <?php echo e(__('email can not be empty')); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dhakaClub\core\resources\views/backend/email/sendEmailToSubscriber.blade.php ENDPATH**/ ?>